...
export default {
  ...
  methods: {
    ...
    async insertContact() {
      ...
      await this.$axios.post("http://127.0.0.1:80/api/contact/", sendData);
      this.getContact();
    },
    async updateContact(id, name, email) {
      ...
      await this.$axios.put(
        "http://127.0.0.1:80/api/contact/" + id,
        sendData
      );
      this.getContact();
    },
    async deleteContact(id) {
      await this.$axios.delete("http://127.0.0.1:80/api/contact/" + id);
      this.getContact();
    },
  },
  created() {
